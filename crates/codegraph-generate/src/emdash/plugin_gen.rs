...
struct SiteContext<'a> {
    p: &'a EmdashPackageContext,
    list: &'a crate::emdash::context::EntityCtx,
    detail: &'a crate::emdash::context::EntityCtx,
    submit: Option<&'a crate::emdash::context::EntityCtx>,
}
...
impl EmdashPluginGenerator {
    ...
    async fn build_entities(
        ...
        config: &DomainConfig,
        project: &ProjectConfig,
    ) -> Result<Vec<crate::emdash::context::EntityCtx>> {
