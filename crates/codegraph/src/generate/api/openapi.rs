...
impl GlobalGenerator for OpenApiGenerator {
    ...
    async fn generate(
        ...
        let security_content = render_template(tera, "api/openapi_security.tera", &empty_ctx)?;
        ...
        let all_ctx = OpenApiContext {
            title: "HR Open API".to_string(),
            version: "1.0.0".to_string(),
            domains: domains.clone(),
        };
        let all_content = render_template(tera, "api/openapi_all.tera", &all_ctx)?;
        files.push(GeneratedFile {
        ...
        for domain in &domains {
            let ctx = PerDomainOpenApiContext {
                title: format!("HR Open API — {}", domain.label),
                version: "1.0.0".to_string(),
                domain_name: domain.name.clone(),
                domain_label: domain.label.clone(),
                entities: domain.entities.clone(),
            };
            let content = render_template(tera, "api/openapi_domain.tera", &ctx)?;
            files.push(GeneratedFile {
        ...
        let catalog_content = render_template(tera, "api/openapi_catalog.tera", &catalog_ctx)?;
        files.push(GeneratedFile {
        ...
        let mut mod_lines = vec![
            ...
            "//! Generated by hr-graph. DO NOT EDIT.".to_string(),
            String::new(),
