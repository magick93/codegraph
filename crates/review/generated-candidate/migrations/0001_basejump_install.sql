-- Migration generated by dbdev add at: 2025-11-06 22:07:00
-- Extension: basejump@basejump_core
-- Default version: 2.0.1
-- Comment: Basejump adds accounts, teams, permissions and billing to Supabase
-------------------------------------- Initial installation of version: 2.0.1
select pgtle.install_extension('basejump@basejump_core', '2.0.1', $comment_HIcAsXf8tHECkGrX$Basejump adds accounts, teams, permissions and billing to Supabase$comment_HIcAsXf8tHECkGrX$, $sql_HIcAsXf8tHECkGrX$/**
      ____                 _
     |  _ \               (_)
...
$sql_HIcAsXf8tHECkGrX$, array[]::text[] );

-- Install version 2.0.0
select pgtle.install_extension_version_sql('basejump@basejump_core', '2.0.0', $sql_HIcAsXf8tHECkGrX$/**
      ____                 _
     |  _ \               (_)
     | |_) | __ _ ___  ___ _ _   _ _ __ ___  _ __
     |  _ < / _` / __|/ _ \ | | | | '_ ` _ \| '_ \
...
select pgtle.set_default_version('basejump@basejump_core', '2.0.1');
