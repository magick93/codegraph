...
mod tests {
    ...
    fn test_pay_run_create_dto_deserializes() {
        let json = r#"{ }"#;
        let _result: Result<cosmos::domain::compensation::pay_run::dto_create::CreatePayRunRequest, _> =
    ...
    fn test_pay_run_response_serializes() {
        ...
        let response = cosmos::domain::compensation::pay_run::dto_response::PayRunResponse {
            id: uuid::Uuid::new_v4(),
    ...
    fn test_pay_run_create_body_single_deserializes() {
        ...
        let json = r#"{ }"#;
        let body: cosmos::api::compensation::pay_run_handler::CreatePayRunBody =
            serde_json::from_str(json).expect("single object should deserialize as CreateBody::Single");
        assert!(matches!(body, cosmos::api::compensation::pay_run_handler::CreatePayRunBody::Single(_)));
    }
    ...
    fn test_pay_run_create_body_bulk_deserializes() {
        ...
        assert!(matches!(body, cosmos::api::compensation::pay_run_handler::CreatePayRunBody::Bulk(ref items) if items.len() == 2));
    }
    ...
    fn test_pay_run_create_body_empty_array_deserializes() {
        ...
        assert!(matches!(body, cosmos::api::compensation::pay_run_handler::CreatePayRunBody::Bulk(ref items) if items.is_empty()));
    }

    #[test]
    fn test_pay_run_bulk_create_response_serializes() {
        // Verify BulkCreateResponse serializes with correct JSON structure
        let response = cosmos::api::compensation::pay_run_handler::BulkCreateResponse {
            success: vec![
                cosmos::domain::compensation::pay_run::dto_response::PayRunResponse {
                    id: uuid::Uuid::new_v4(),
                    created_at: chrono::Utc::now(),
                    updated_at: chrono::Utc::now(),
                    ..Default::default()
            ...
            failed: vec![
                cosmos::api::compensation::pay_run_handler::BulkItemError {
                    index: 1,
