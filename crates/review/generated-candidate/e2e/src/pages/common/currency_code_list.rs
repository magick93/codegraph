...
// Page Object Model for CurrencyCodeList.
...
pub struct CurrencyCodeListPage<'a> {
    pub page: &'a Page,
}

impl<'a> CurrencyCodeListPage<'a> {
    ...
    pub async fn goto_list(&self) -> Result<()> {
        self.page.goto_builder(&format!("{}/common/currency-code-list", Self::base_url())).goto().await?;
        Ok(())
    }


    pub async fn goto_create(&self) -> Result<()> {
        self.page.goto_builder(&format!("{}/common/currency-code-list/new", Self::base_url())).goto().await?;
        Ok(())
    }
    ...
    pub async fn goto_detail(&self, id: &str) -> Result<()> {
        self.page
            .goto_builder(&format!("{}/common/currency-code-list/{id}", Self::base_url()))
            .goto()
            .await?;
        Ok(())
    }
    ...
    pub async fn submit(&self) -> Result<()> {
        self.page
            .click_builder("[data-testid=\"currency_code_list-submit-btn\"]")
            .click()
            .await?;
        Ok(())
    }
    ...
    pub async fn delete(&self) -> Result<()> {
        self.page
            .click_builder("[data-testid=\"currency_code_list-delete-btn\"]")
            .click()
            .await?;
        self.page
