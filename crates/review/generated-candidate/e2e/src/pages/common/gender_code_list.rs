...
// Page Object Model for GenderCodeList.
...
pub struct GenderCodeListPage<'a> {
    pub page: &'a Page,
}

impl<'a> GenderCodeListPage<'a> {
    ...
    pub async fn goto_list(&self) -> Result<()> {
        self.page.goto_builder(&format!("{}/common/gender-code-list", Self::base_url())).goto().await?;
        Ok(())
    }


    pub async fn goto_create(&self) -> Result<()> {
        self.page.goto_builder(&format!("{}/common/gender-code-list/new", Self::base_url())).goto().await?;
        Ok(())
    }
    ...
    pub async fn goto_detail(&self, id: &str) -> Result<()> {
        self.page
            .goto_builder(&format!("{}/common/gender-code-list/{id}", Self::base_url()))
            .goto()
            .await?;
        Ok(())
    }
    ...
    pub async fn submit(&self) -> Result<()> {
        self.page
            .click_builder("[data-testid=\"gender_code_list-submit-btn\"]")
            .click()
            .await?;
        Ok(())
    }
    ...
    pub async fn delete(&self) -> Result<()> {
        self.page
            .click_builder("[data-testid=\"gender_code_list-delete-btn\"]")
            .click()
            .await?;
        self.page
