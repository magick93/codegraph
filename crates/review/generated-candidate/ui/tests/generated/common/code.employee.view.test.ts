...
test.describe.serial('Code Employee View', () => {
  ...
  test('employee can see Code list', async ({ employeePage }) => {
    await employeePage.goto(BASE_PATH);
    const table = employeePage.locator('[data-testid="code-table"]');
    const empty = employeePage.locator('[data-testid="code-empty"]');
