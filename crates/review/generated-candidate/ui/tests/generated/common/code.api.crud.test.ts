...
test.describe('Code CRUD', () => {
  ...
  test('list page loads with table', async ({ ownerPage: page }) => {
    ...
    const table = page.locator('[data-testid="code-table"]');
    const empty = page.locator('[data-testid="code-empty"]');
  ...
  test('delete entity', async ({ ownerPage: page, orgContext }) => {
    ...
    await waitForHydration(page, '[data-testid="code-delete-btn"]');
    await page.locator('[data-testid="code-delete-btn"]').click();
