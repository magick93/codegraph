...
test.describe.serial('CurrencyCodeList Employee View', () => {
  ...
  test('employee can view CurrencyCodeList detail', async ({ employeePage }) => {
    ...
    await expect(employeePage.locator('[data-testid="currency_code_list-field-code"]')).toBeVisible();
    await expect(employeePage.locator('[data-testid="currency_code_list-field-display_name"]')).toBeVisible();
