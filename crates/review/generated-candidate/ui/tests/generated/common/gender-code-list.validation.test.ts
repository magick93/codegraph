...
// Validation E2E tests for GenderCodeList.
...
test.describe('GenderCodeList Validation', () => {
  ...
  test('invalid field types rejected', async ({ ownerPage }) => {
    ...
    await expect(ownerPage.locator('[data-testid="gender_code_list-submit-btn"]')).toBeVisible();
