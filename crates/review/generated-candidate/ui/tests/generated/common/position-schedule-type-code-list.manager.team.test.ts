...
test.describe.serial('PositionScheduleTypeCodeList Manager Team', () => {
  ...
  test('manager can see PositionScheduleTypeCodeList list', async ({ managerPage }) => {
    await managerPage.goto(BASE_PATH);
    const table = managerPage.locator('[data-testid="position_schedule_type_code_list-table"]');
    const empty = managerPage.locator('[data-testid="position_schedule_type_code_list-empty"]');
  ...
  test('manager can view PositionScheduleTypeCodeList detail', async ({ managerPage }) => {
    ...
    await expect(managerPage.locator('[data-testid="position_schedule_type_code_list-field-code"]')).toBeVisible();
    await expect(managerPage.locator('[data-testid="position_schedule_type_code_list-field-display_name"]')).toBeVisible();
