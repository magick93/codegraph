...
// CRUD E2E tests for GenderCodeList.
...
test.describe('GenderCodeList CRUD', () => {
  ...
  test('list page loads with table', async ({ ownerPage: page }) => {
    ...
    const table = page.locator('[data-testid="gender_code_list-table"]');
    const empty = page.locator('[data-testid="gender_code_list-empty"]');
  ...
  test('delete entity', async ({ ownerPage: page, orgContext }) => {
    ...
    await waitForHydration(page, '[data-testid="gender_code_list-delete-btn"]');
    await page.locator('[data-testid="gender_code_list-delete-btn"]').click();
