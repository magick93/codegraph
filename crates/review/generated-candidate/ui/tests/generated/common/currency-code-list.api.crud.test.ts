...
test.describe('CurrencyCodeList CRUD', () => {
  ...
  test('create entity via form', async ({ ownerPage: page }) => {
    ...
    if (await page.locator('[data-testid="currency_code_list-field-display_name"]').count() > 0) {
      await expect(page.locator('[data-testid="currency_code_list-field-display_name"]')).toBeVisible();
    }



    if (await page.locator('[data-testid="currency_code_list-field-sort_order"]').count() > 0) {
      await expect(page.locator('[data-testid="currency_code_list-field-sort_order"]')).toBeVisible();
    }
