...
// Validation E2E tests for EffectiveDate.
...
test.describe('EffectiveDate Validation', () => {
  ...
  test('invalid field types rejected', async ({ ownerPage }) => {
    ...
    await expect(ownerPage.locator('[data-testid="effective_date-submit-btn"]')).toBeVisible();
