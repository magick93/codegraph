...
test.describe.serial('PersonBase Owner CRUD', () => {
  ...
  test('owner can view PersonBase detail', async ({ ownerPage }) => {
  ...
  test('owner can edit PersonBase', async ({ ownerPage }) => {
  ...
  test('owner can delete PersonBase', async ({ ownerPage }) => {
