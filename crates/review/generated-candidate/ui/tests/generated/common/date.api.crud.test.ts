...
test.describe('Date CRUD', () => {
  ...
  test('list page loads with table', async ({ ownerPage: page }) => {
    ...
    const table = page.locator('[data-testid="date-table"]');
    const empty = page.locator('[data-testid="date-empty"]');
  ...
  test('delete entity', async ({ ownerPage: page, orgContext }) => {
    ...
    await waitForHydration(page, '[data-testid="date-delete-btn"]');
    await page.locator('[data-testid="date-delete-btn"]').click();
