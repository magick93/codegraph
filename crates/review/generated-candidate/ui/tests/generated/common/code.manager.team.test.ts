...
test.describe.serial('Code Manager Team', () => {
  ...
  test('manager can see Code list', async ({ managerPage }) => {
    await managerPage.goto(BASE_PATH);
    const table = managerPage.locator('[data-testid="code-table"]');
    const empty = managerPage.locator('[data-testid="code-empty"]');
