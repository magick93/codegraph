...
// Validation E2E tests for ProcessHistory.
...
test.describe('ProcessHistory Validation', () => {
  ...
  test('invalid field types rejected', async ({ ownerPage }) => {
    ...
    await expect(ownerPage.locator('[data-testid="process_history-submit-btn"]')).toBeVisible();
