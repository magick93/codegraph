...
export const load: PageServerLoad = async ({ url, params, locals, fetch: skFetch }) => {
	const grandparentId = params.candidate_id;
	const parentId = params.application_id;
	...
	const apiUrl = new URL(`${BASE_URL}/api/recruiting/candidate/${grandparentId}/application/${parentId}/candidate`);
