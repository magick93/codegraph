...
export const load: PageServerLoad = async ({ params, locals, fetch: skFetch }) => {
	...
	try {
		...
		const wfRes = await skFetch(`${BASE_URL}/api/recruiting/candidate/${params.candidate_id}/application/${params.application_id}/candidate/${params.candidate_id}/workflow`, { headers });
