...
pub async fn create_endpoint(
    ...
    let headers_json = serde_json::to_string(&headers)
        .unwrap_or_default()
        .replace('\'', "''");
    let escaped_url = body.url.replace('\'', "''");
    let description_expr = match &body.description {
    ...
    tx.execute(Statement::from_string(
        ...
        format!(
            ...
            id, tenant_id, escaped_url, hmac_secret, description_expr, headers_json, now_str, now_str
        ),
    ))
    .await
    .map_err(|e| {
...
pub async fn create_subscription(
    ...
    let filter_json = serde_json::to_string(&filter)
        .unwrap_or_default()
        .replace('\'', "''");
    let event_entity_expr = match &body.event_entity {
        Some(e) => format!("'{}'", e.replace('\'', "''")),
        None => "NULL".to_string(),
    };
    let event_type_expr = match &body.event_type {
    ...
    tx.execute(Statement::from_string(
        ...
        format!(
            ...
            id, tenant_id, endpoint_id, body.event_domain.replace('\'', "''"), event_entity_expr, event_type_expr, filter_json, now_str
        ),
    ))
    .await
    .map_err(|e| {
