...
pub use domain_types::common::name::NameResponse;


/// Response wrapper that includes HAL-style `_links` for HATEOAS discoverability.
#[derive(Debug, Clone, serde::Serialize, serde::Deserialize, utoipa::ToSchema)]
pub struct NameLinkedResponse {
    /// The entity data.
    #[serde(flatten)]
    pub data: NameResponse,
...
#[allow(dead_code)]
impl NameLinkedResponse {
    /// Wrap a response with self-link for a root entity.
    pub fn root(data: NameResponse, domain: &str, path_segment: &str) -> Self {
