//! CQRS query handlers for EventBase.
...
#[derive(Clone)]
pub struct EventBaseQueryHandler {
...
impl EventBaseQueryHandler {
    ...
    pub async fn find_by_id(&self, id: Uuid, include_deleted: bool, api_key_id: Uuid, organization_id: Uuid, user_id: Uuid, role: String) -> Result<Option<EventBaseResponse>, CommonError> {
    ...
    pub async fn list_filtered(&self, page: u64, page_size: u64, filters: &std::collections::HashMap<String, String>, include_deleted: bool, api_key_id: Uuid, organization_id: Uuid, user_id: Uuid, role: String) -> Result<(Vec<EventBaseResponse>, u64), CommonError> {
