...
pub struct DistributionBaseCommandHandler {
    repo: Arc<dyn DistributionBaseRepository>,
...
impl DistributionBaseCommandHandler {
    ...
    pub async fn create(&self, cmd: CreateDistributionBaseRequest, source: domain_types::SourceContext, correlation_id: Uuid, api_key_id: Uuid, organization_id: Uuid) -> Result<Uuid, Box<dyn std::error::Error>> {
    ...
    pub async fn update(&self, id: Uuid, cmd: UpdateDistributionBaseRequest, source: domain_types::SourceContext, correlation_id: Uuid, api_key_id: Uuid, organization_id: Uuid) -> Result<(), Box<dyn std::error::Error>> {
        let tx = self.db.begin().await?;
        set_rls_session_vars(&tx, api_key_id, organization_id, correlation_id).await?;
