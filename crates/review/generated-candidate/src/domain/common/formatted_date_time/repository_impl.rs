//! Generated repository implementation for FormattedDateTime.
...
impl FormattedDateTimeRepository<sea_orm::DatabaseTransaction> for FormattedDateTimeRepositoryImpl {
    ...
    async fn create(
        ...
        // Insert into common.formatted_date_time (direct columns)
    ...
    #[tracing::instrument(skip(self, db), fields(db.operation = "select", db.table = "common.formatted_date_time"))]
    async fn find_by_id(
        &self,
        ...
        Ok(Some(FormattedDateTimeResponse {
            id: row.id,
    ...
    #[tracing::instrument(skip(self, tx), fields(db.operation = "update", db.table = "common.formatted_date_time"))]
    async fn update(
        &self,
        tx: &DatabaseTransaction,
        id: Uuid,
    ...
    #[tracing::instrument(skip(self, tx), fields(db.operation = "delete", db.table = "common.formatted_date_time"))]
    async fn delete(
        &self,
        tx: &DatabaseTransaction,
        id: Uuid,
    ) -> Result<(), Box<dyn std::error::Error>> {
        let model = crate::entity::common_formatted_date_time::Entity::find()
            .filter(crate::entity::common_formatted_date_time::Column::Id.eq(id))
        ...
        let mut active: crate::entity::common_formatted_date_time::ActiveModel = model.into();
    ...
    #[tracing::instrument(skip(self, db), fields(db.operation = "select_list", db.table = "common.formatted_date_time"))]
    async fn list(
        &self,
        db: &DatabaseTransaction,
        page: u64,
...
;
        ...
        for row in rows {
            results.push(FormattedDateTimeResponse {
                id: row.id,
                created_at: row.created_at,
                updated_at: row.updated_at,
                ..Default::default()
