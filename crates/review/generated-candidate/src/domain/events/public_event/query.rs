//! CQRS query handlers for PublicEvent.
...
#[derive(Clone)]
pub struct PublicEventQueryHandler {
...
impl PublicEventQueryHandler {
    ...
    pub async fn find_by_id(&self, id: Uuid, include_deleted: bool, api_key_id: Uuid, organization_id: Uuid, user_id: Uuid, role: String) -> Result<Option<PublicEventResponse>, EventsError> {
        ...
        let mut result = self.repo.find_by_id(&tx, id, include_deleted).await
            .map_err(|e| EventsError::from_repo_err(e))?;
        tx.commit().await?;
    ...
    pub async fn list_filtered(&self, page: u64, page_size: u64, filters: &std::collections::HashMap<String, String>, include_deleted: bool, api_key_id: Uuid, organization_id: Uuid, user_id: Uuid, role: String) -> Result<(Vec<PublicEventResponse>, u64), EventsError> {
