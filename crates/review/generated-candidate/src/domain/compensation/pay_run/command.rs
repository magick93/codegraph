...
impl PayRunCommandHandler {
    ...
    pub async fn create(&self, cmd: CreatePayRunRequest, source: domain_types::SourceContext, correlation_id: Uuid, api_key_id: Uuid, organization_id: Uuid, user_id: Uuid) -> Result<Uuid, CompensationError> {
    ...
    pub async fn update(&self, id: Uuid, cmd: UpdatePayRunRequest, source: domain_types::SourceContext, correlation_id: Uuid, api_key_id: Uuid, organization_id: Uuid, user_id: Uuid) -> Result<(), CompensationError> {
    ...
    pub async fn delete(&self, id: Uuid, source: domain_types::SourceContext, correlation_id: Uuid, api_key_id: Uuid, organization_id: Uuid, user_id: Uuid) -> Result<(), CompensationError> {
