...
pub struct PayRunCommandHandler {
    ...
    repo: Arc<dyn PayRunRepository<sea_orm::DatabaseTransaction>>,
...
impl PayRunCommandHandler {
    ...
    pub async fn create(&self, cmd: CreatePayRunRequest, source: domain_types::SourceContext, correlation_id: Uuid, api_key_id: Uuid, organization_id: Uuid, user_id: Uuid, role: String) -> Result<Uuid, CompensationError> {
    ...
    pub async fn update(&self, id: Uuid, cmd: UpdatePayRunRequest, source: domain_types::SourceContext, correlation_id: Uuid, api_key_id: Uuid, organization_id: Uuid, user_id: Uuid, role: String) -> Result<(), CompensationError> {
    ...
    pub async fn delete(&self, id: Uuid, source: domain_types::SourceContext, correlation_id: Uuid, api_key_id: Uuid, organization_id: Uuid, user_id: Uuid, role: String) -> Result<(), CompensationError> {
