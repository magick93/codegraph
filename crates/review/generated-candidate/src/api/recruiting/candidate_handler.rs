...
pub async fn create(
    ...
    match body {
        CreateCandidateBody::Single(item) => {
            ...
            let id = state.recruiting_candidate_commands.create(item, hr_domain_types::SourceContext::api(), correlation_id, api_key_info.api_key_id, api_key_info.organization_id).await
        ...
        CreateCandidateBody::Bulk(items) => {
            ...
            let result = state.recruiting_candidate_commands.bulk_create(items, hr_domain_types::SourceContext::api(), correlation_id, api_key_info.api_key_id, api_key_info.organization_id).await;
...
#[utoipa::path(
    ...
    tag = "Candidate",
    responses(
        (status = 200, description = "OK", body = CandidateLinkedResponse),
...
pub async fn update(
    ...
    state.recruiting_candidate_commands.update(id, body, hr_domain_types::SourceContext::api(), correlation_id, api_key_info.api_key_id, api_key_info.organization_id).await
